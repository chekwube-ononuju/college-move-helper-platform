...
export default function BecomeHelper() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Success!",
        description: "You're now registered as a helper on College Movers!"
      });
            ...
            <Card className="mb-6 bg-slate-50">
              ...
              <CardContent>
                <p className="text-sm mb-4">
                  College Movers charges a {PLATFORM_FEE_PERCENTAGE}% platform fee on all payments received by helpers. This fee helps us maintain and improve the platform, provide customer support, and handle payment processing.
                </p>

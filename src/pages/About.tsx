...
export default function About() {
  return (
    <MainLayout title="About College Movers">
      <div className="max-w-3xl mx-auto">
        <div className="space-y-8">
          <section>
            <h2 className="text-2xl font-bold mb-4">Our Mission</h2>
            <p className="text-muted-foreground">
              College Movers connects students who need moving assistance with fellow students 
          ...
          <section>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  College Movers charges a {PLATFORM_FEE_PERCENTAGE}% fee on all completed jobs
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="mb-4">
                  To sustain and improve our platform, College Movers charges a {PLATFORM_FEE_PERCENTAGE}% fee on all 
                ...
                <div className="mt-6 text-sm text-muted-foreground">
                  <p>
                    ...
                    is calculated when helpers report completed jobs, but College Movers does not handle 
          ...
          <section>
            ...
            <p className="mt-2">
              Email: <a href="mailto:support@collegemovers.com" className="text-primary hover:underline">support@collegemovers.com</a>
            </p>
          </section>
        </div>
      </div>
